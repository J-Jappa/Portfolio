...
- Constant-speed runs with repeat passes and averaging  
- Known mass and tyre pressures to hold rolling resistance stable  
- Basic coast-down sanity checks against the constant-speed result  
- Visual inspection of surface finish and panel alignment before runs
