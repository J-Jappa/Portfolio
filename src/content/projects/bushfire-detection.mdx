---
title: "Early Bushfire Detection on IoT Sensors"
...
date: "2025-11-22"
order: 1
hero: "/images/bushfire/GGM-VAE Pipeline.png"
images:
...
stat: "All eight test ignitions caught, first detection about 4 minutes"
outcomes:
...
<Figure
  src="/images/bushfire/GGM-VAE Pipeline.png"
  alt="GGM-VAE anomaly pipeline"
  maxWidth="720px"
/>
...
<Figure
  src="/images/bushfire/Hybrid-VAE Pipeline.PNG"
  alt="Hybrid-VAE anomaly pipeline"
  maxWidth="720px"
/>
...
When I sweep the threshold, the GGM-VAE also shows a better **latency vs F1 trade-off** than the Hybrid-VAE, meaning it’s the more flexible model for deployment tuning.
...
<Figure
  src="/images/bushfire/Hardware Diagram.PNG"
...
- Inference time for a 15 s window sits around **130 to 170 ms**, well within the 1 Hz sampling budget.
...
This page is the short version. The full write up, _Unsupervised Deep Learning Algorithms for Early Bushfire Detection_, covers the literature, the maths behind both models, the tuning studies and the complete hardware evaluation.

<PdfEmbed
  src="/JasperJapp_Thesis.pdf"
  title="Unsupervised Deep Learning Algorithms for Early Bushfire Detection"
/>
