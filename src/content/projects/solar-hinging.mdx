...
summary: "Hinges and carbon stays that tilt the solar array to 60° for morning and evening charging at roadside stops."
order: 4
date: "2025-02-10"
...
stat: "60° tilt for morning and evening charging"
outcomes:
  - "Hits the 60° tilt target, making early and late charging worthwhile on a limited battery buffer."
  - "Deployed repeatedly at control stops and camps through the race."
  - "Held the set angle on carbon stays, stable in wind."
#repo: ""
#link: ""
---
...
Fit and motion were checked on the car before the race. The real proof was use: the array opened at control stops and for morning and evening charging at camps, and the stays held the set angle in wind through repeated deployments.
